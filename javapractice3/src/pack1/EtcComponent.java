...
//Radio
		...
		rad3 = new Checkbox("rectangle", group, false);
...
//Choice
		...
		pn1.add(new Label("select color", Label.RIGHT));
...
//Checkbox
		...
		chk2 = new Checkbox("jap", false);

		chk3 = new Checkbox("ame", false);

		pn2 = new Panel();

		btnOk = new Button("check");

		btnOk.addActionListener(this);

		pn2.add(new Label("you want country : "));
